...
{\bfseries{1. Transfer the box list\+:}}

$\ast$$\ast$(1).Use your own transfer funciton\+:$\ast$$\ast$ 
\begin{DoxyCode}{0}
\DoxyCodeLine{void TransferBox(const BoxPtr\_t \&box)}
\DoxyCodeLine{\{}
...
$\ast$$\ast$(2).Use M\+P4\+Parser\textquotesingle{}s transfer function\+:$\ast$$\ast$ 
\begin{DoxyCode}{0}
\DoxyCodeLine{int TransferFunc(BoxPtr\_t\& box, void *p\_userData)}
\DoxyCodeLine{\{}
...
\DoxyCodeLine{    }
\DoxyCodeLine{    mp4Parser.parse("/your/mp4file/path/file.mp4");}
\DoxyCodeLine{    mp4Parser.transfer(TransferFunc, \&count);}
